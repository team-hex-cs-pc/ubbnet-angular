...
export class UserService {
  ...
  private usersUrl = 'https://dev.api.teamhex.laurcons.ro/api/user';
  ...
  async login(email: string, password: string): Promise<AuthResponse> {
    const res = this.httpClient.post<AuthResponse>(
      'https://dev.api.teamhex.laurcons.ro/api/user/login',
      {
        email,
        password,
      },
  ...
  async getUserByUsername(username: string): Promise<User> {
    const result = this.httpClient.get<User>(
      `https://dev.api.teamhex.laurcons.ro/api/user/${username}`,
      this.header
    );
  ...
  async getUserInformation() {
    this.httpClient
      .get<User>('https://dev.api.teamhex.laurcons.ro/api/user/details', {
        headers: new HttpHeaders({
